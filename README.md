...
$headers[] = "Accept: application/json, text/plain, */*";
$headers[] = "Authorization: Bearer $bearer";
$headers[] = "User-Agent: Mozilla/5.0 (Linux; Android 6.0; Redmi Note 3 Kenzo Build/LRX21T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Mobile Safari/537.36";
$headers[] = "Content-Type: application/json";
$headers[] = "Origin: http://bonstri.tri.co.id";
$headers[] = "Referer: http://bonstri.tri.co.id/voucherku";
$headers[] = "Accept-Encoding: gzip, deflate";
